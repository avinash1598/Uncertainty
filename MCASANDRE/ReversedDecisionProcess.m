...
sigma_m                 = 5;                         % Meta-uncertainty - some constant
Cc                      = 0.3;                         % Confidence criteria
...
for level = 1:n_levels
    ...
    for i = 1:n_theta
        ...
        % Step2: Using estimate of this uncertainty, the subject estimates
        % the orientation
        ...
        theta_est = theta_true + sigma_hat .* randn(trials, 1);
