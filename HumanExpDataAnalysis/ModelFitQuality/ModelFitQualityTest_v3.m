...
% addpath('C:\Users\avinash1598\Desktop\Uncertainty\LLScriptsUtils\LLScriptsModel_v3\')
% addpath('C:\Users\avinash1598\Desktop\Uncertainty\PlotUtils\')
% addpath('C:\Users\avinash1598\Desktop\Uncertainty\Utils\')
% addpath('C:\Users\avinash1598\Desktop\Uncertainty\OptimizationScripts_v3\')
...
% ----------------------------------------
optParams.nStarts = 300; %300;optParams.nStarts = 30;
result = Optimize(formattedData, initCond, [], optParams);

%% Data structures to save
dataToSave.result   = result;
save('./Data/ModelFitQualityTest_Akash_v3.mat', "dataToSave");
