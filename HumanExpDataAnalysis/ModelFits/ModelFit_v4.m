...
%%
save("../Data/yichao_fit_model_v4.mat", "result");

%%
% load('../Data/akash_fit_model_v4.mat');
errBins   = -90:3:90; 
...
opt_param_b                 = result.x(idx, n_uncertainty_levels+1:2*n_uncertainty_levels);
...
opt_param_ori_scale         = result.x(idx, 2*n_uncertainty_levels + 5);
opt_param_bias              = result.x(idx, 2*n_uncertainty_levels + 6);
...
for i =1:n_uncertainty_levels
    fprintf("b: Fit: %.4f C: %.3f, S: %.3f, D: %.3f\n", ...
        opt_param_b(i), ...
        formattedData.uncertaintyVals(i, 1), ...
        formattedData.uncertaintyVals(i, 2), ...
        formattedData.uncertaintyVals(i, 3))
