...
data = load('C:\Users\avinash1598\Desktop\Uncertainty\HumanExpDataAnalysis\Data\CORNFB03.mat'); % David
...
% modelFun = @(params, ori) params(1) .* cosd(2*ori);
initParams = [ rand ];
...
plot(orientations, b_est .* sind(4*orientations))
hold off
xlabel("Orientation")
ylabel("Mean error")
title("Orientation bias")
