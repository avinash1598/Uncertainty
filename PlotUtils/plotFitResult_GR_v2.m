function plotFitResult_GR_v2(data, modelParams, initCond, modelType, fitType, errBins)
...
if modelType == "cov"
    ...
    param_guessrate      = modelParams(n_uncertainty_levels + 4:2*n_uncertainty_levels+3);
...
elseif modelType == "ind"
    ...
    param_guessrate      = modelParams(n_uncertainty_levels + 5:2*n_uncertainty_levels+4);
...
for i=1:n_uncertainty_levels
    ...
    mP.guessRate           = param_guessrate(i);
