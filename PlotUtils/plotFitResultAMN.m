function plotFitResultAMN(data, modelParams, initCond, errBins)
...
param_ext_noise_scale    = modelParams(n_uncertainty_levels + 1:2*n_uncertainty_levels);
...
for i=1:n_uncertainty_levels
    ...
    mP.ext_noise_scale     = param_ext_noise_scale(i);
    ...
    analyticalSol = getPDFs(mP, false);
...
[~, idxSorted] = sort(anlytcl_sigma_m);
