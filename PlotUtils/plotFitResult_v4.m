function plotFitResult_v4(data, modelParams, initCond, errBins)
...
param_b                 = modelParams(n_uncertainty_levels+1:2*n_uncertainty_levels);
...
param_ori_scale         = modelParams(2*n_uncertainty_levels + 5);
...
for i=1:n_uncertainty_levels
    ...
    analyticalSol = getPDFs_v4(mP, data.orientations', false);
