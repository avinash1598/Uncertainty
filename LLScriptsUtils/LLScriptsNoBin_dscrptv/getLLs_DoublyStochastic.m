function [retData] = getLLs_DoublyStochastic(trlErrors, trlConfReports, trlStimOris, uniqStimVals, modelParams)
...
scale                     = modelParams.scale;   % scale of gamma or var of log normal
Cc                        = modelParams.Cc;
...
for i = 1:numOris
    ...
    % and variance
    m = sigma_s_stim(i).^2; v = scale; % desired mean & variance of lognormal distribution
