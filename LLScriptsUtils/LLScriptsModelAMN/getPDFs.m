function [retData] = getPDFs(modelParams, optimizationFlag)
...
ext_noise_scale           = modelParams.ext_noise_scale; % make this uncertainty level dependent
...
shapeParam   = ext_noise_scale*(sigma_ext.^2) ./ scaleParam;
