function nlls = getNLLForEachTrial(data, initCond, modelType, fitType, modelParams, fltTrlIdx)
    ...
    if modelType == "cov"
        nlls = computeNLLCov_binned(modelParams, metaData, fitType, false); 
    elseif modelType == "ind"
        nlls = computeNLL_binned(modelParams, metaData, fitType, false); 
    elseif modelType == "singlyStochastic"
        nlls = computeNLL_SinglyStochastic_binned(modelParams, metaData, fitType, false);
    else
        nlls = nan;
    end
end
