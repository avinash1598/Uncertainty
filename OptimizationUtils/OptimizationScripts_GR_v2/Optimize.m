...
if model == "cov"
    nParams = 2*n_uncertainty_levels + 3;
elseif model == "ind"
...
parfor itr = 1:nStarts
    ...
    while ~success
        try 
            ...
            param_Cc             = rand;
            param_guessrate      = 0.1*rand(1, n_uncertainty_levels);
            ...
            ub(end - n_uncertainty_levels + 1: end) = 1; % Upper bound for guessrate parameters 
