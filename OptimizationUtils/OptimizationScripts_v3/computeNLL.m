...
for i=1:nLevels
    ...
    modelParams.sigma_int           = param_sigma_int(i); %param_sigma_int(i);
    ...
    retData = getPDFs_v3(modelParams, true); % originally set to true
