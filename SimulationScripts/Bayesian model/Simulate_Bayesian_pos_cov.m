...
% biasAmp          = 0.5;
k                = 2;   % Some constant for setting covariance b/w sigma_si and sigma_s_stim
shape            = 2;
scale            = 0.5;
sigma_meta       = 0.2;
Cc               = 1;
...
for l=1:uncertainty_levels
    for i = 1:n_theta
        ...
        % independent case: sensory noise only sets the mean of gamma
        % distribution
        % Covariable: sensory noise sets both mean and variance of gamma
        % distribution.
        sigma_si = k*sigma_s_stim(l, i)*gamrnd(shape, scale, [trials 1]); % This might not be the correct approach to set covariability. But, do I have to spend lot of time on this?
