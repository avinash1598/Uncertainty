...
for l=1:uncertainty_levels
    for i = 1:n_theta
        ...
        sigma_si_modulated = gain*k*sigma_s_stim(l, i);
        sigma_m_stim = sqrt(sigma_s_stim(l, i).^2 + sigma_si_modulated.^2);
        % sigma_m_stim = gamrnd(sigma_s_stim(l, i), varGain, [trials 1]); % This gives slightly different prediction
