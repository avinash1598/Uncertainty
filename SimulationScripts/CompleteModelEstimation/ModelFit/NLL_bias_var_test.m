...
optRunData.gtParams    = zeros(numel(nTrialsList), nItr, 10);
optRunData.estParams   = zeros(numel(nTrialsList), nItr, 10);
...
for i = 1:numel(nTrialsList)
    ...
    for j = 1:nItr
        ...
        while ~success
            ...
            try
                ...
                optRunData.gtParams(i, j, :) = [gt_sigma_s gt_shape gt_scale gt_sigma_meta gt_Cc];
                optRunData.estParams(i, j, :) = [opt_param_sigma_s opt_param_shape opt_param_scale opt_param_sigma_meta opt_param_Cc];
    ...
    save('NLL_bias_var_test_data.mat', "optRunData");
end
