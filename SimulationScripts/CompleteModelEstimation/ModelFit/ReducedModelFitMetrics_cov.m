...
% data = load('ModelFitMetrics_cov_t1000.mat'); 
% data = load('ModelFitMetrics_cov_t25_cnstrnt.mat'); % 25 trials per ori
data = load('ModelFitMetrics_cov_common_objective_t25.mat'); 
% data = load('ModelFitMetrics_cov.mat'); % 25 trials per ori
% data = load('ModelFitMetrics_cov_t1000.mat');
