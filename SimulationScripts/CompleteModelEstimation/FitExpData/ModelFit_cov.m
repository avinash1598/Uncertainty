...
opt_param_scale          = optimalValues(uncertainty_levels + 1);
opt_param_sigma_meta     = optimalValues(uncertainty_levels + 2);
opt_param_Cc             = optimalValues(uncertainty_levels + 3);
...
% mean_sigma_s = opt_param_sigma_s;
mean_sigma_s = 1:uncertainty_levels; % This arranges in increasing uncertainty level (which is what we want)
...
% sum( ( param_sigma_s - targetStds ).^2 ) + ...
...
loss = sum( lossHC +  lossLC , 'all') + ...
    ...
    % + 0.1*sum( (param_sigma_s - targetStds).^2 );
...
% Columns 1 through 9
% 
%    10.7945   13.8753   19.4875   19.5738   22.4642   25.9912   24.9864   26.8053  207.5107
% 
...
% 
%    11.3719   13.8024   19.5073   19.5141   22.2663   25.8765   24.0129   26.0598  332.0092    4.3846
% 
%   Column 11
% 
%     0.0586
