...
data = load('ExpDataModelFitMetrics.mat'); 
...
for i=1:uncertainty_levels
    ...
    modelParams.scale               = fitValues(uncertainty_levels + 1);
    modelParams.sigma_meta          = fitValues(uncertainty_levels + 2);
    modelParams.Cc                  = fitValues(uncertainty_levels + 3);
...
% Whatever is the value of sigma_s it is arranges in order of increasing
% uncertainty as computed from sigma_m.
