...
b                = 1.5;       % Note: different minimum noise level (0.1). Choose b such that average noise level ranges from low to high (relative to internal noise level)
...
conf_variables_all    = zeros(n_theta, ntrials_per_ori);
...
%%
figure
scatter(conf_variables_all(:), resp_err_all(:))
xlabel("Vc")
ylabel("Error")
